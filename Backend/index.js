...
app.post("/api/financial-advice", async (req, res) => {
  ...
  const genAI = new GoogleGenerativeAI("AIzaSyAuVwzksyAl-eATP99mxACJq1Z1MLOscZc"); // Replace with your actual API key
  ...
  try {
    ...
    if (advice) {
        console.log("Generated Advice:", advice); // Log the generated advice on the server
